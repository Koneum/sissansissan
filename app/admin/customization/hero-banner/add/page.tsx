    ...
    <div className="space-y-4 sm:space-y-6 pb-6 sm:pb-8">
      <Card className="border-0 shadow-sm max-w-3xl">
        <CardHeader className="border-b">
          <CardTitle className="heading-responsive-h3">Add Hero Banner</CardTitle>
        </CardHeader>
        <CardContent className="card-responsive space-y-4 sm:space-y-6">
          <div className="space-y-2">
            <Label htmlFor="banner-name" className="text-responsive-sm font-medium text-slate-700 dark:text-slate-300">
              Banner Name
            </Label>
            <Input id="banner-name" placeholder="Enter banner name" className="h-10 sm:h-11" />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input id="subtitle" placeholder="Enter subtitle" className="h-10 sm:h-11" />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input id="slug" placeholder="banner-slug" className="h-10 sm:h-11" />
          </div>

          <div className="space-y-2">
            <Label htmlFor="banner-image" className="text-responsive-sm font-medium text-slate-700 dark:text-slate-300">
