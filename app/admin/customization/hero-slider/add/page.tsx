    ...
    <div className="space-y-6 pb-8">
      <Card className="border-0 shadow-sm max-w-3xl">
        <CardHeader className="border-b">
          <CardTitle className="text-xl font-semibold">Add Hero Slider</CardTitle>
        </CardHeader>
        <CardContent className="p-6 space-y-6">
          <div className="space-y-2">
            <Label htmlFor="slider-name" className="text-sm font-medium text-slate-700 dark:text-slate-300">
              Slider Name <span className="text-red-500">*</span>
            </Label>
            <Input id="slider-name" placeholder="Enter slider name" className="h-11" />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input id="slug" placeholder="slider-slug" className="h-11" />
          </div>

          <div className="space-y-2">
            <Label htmlFor="discount-rate" className="text-sm font-medium text-slate-700 dark:text-slate-300">
              Discount Rate (%) <span className="text-red-500">*</span>
            </Label>
            <Input id="discount-rate" type="number" defaultValue="0" className="h-11" />
          </div>

          <div className="space-y-2">
            <Label htmlFor="slider-image" className="text-sm font-medium text-slate-700 dark:text-slate-300">
