  ...
  return (
    <div className="space-y-6 pb-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-slate-900 dark:text-white">{t.admin.addProduct}</h1>
          <p className="text-sm text-muted-foreground">{t.admin.createNewProduct}</p>
        </div>
      </div>
