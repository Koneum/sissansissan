...
export default function TermsConditionsPage() {
  ...
  const generatePDF = async () => {
    // Create a printable version of the terms
    ...
    const content = pagesData.termsConditions
    ...
    printWindow.document.write(`
      ...
      <head>
        <meta charset="UTF-8">
        <title>Conditions Générales de Vente - ${companyName}</title>
        <style>
          * {
            margin: 0;
            padding: 0;
      ...
      <body>
        ...
        <div class="footer">
          <p>${companyName} - ${footerData.contactInfo?.email || 'contact@sissan-sissan.com'}</p>
      ...
      <main className="container mx-auto px-4 py-8 sm:py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold mb-4">Conditions Générales de Vente</h1>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Veuillez lire attentivement ces conditions avant d'effectuer un achat sur notre site.
            </p>
          </div>
          ...
          <Card className="p-6 sm:p-8 md:p-10 shadow-lg">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              {renderContent(pagesData.termsConditions)}
            </div>
          </Card>
          ...
          <div className="mt-8 text-center">
            <p className="text-muted-foreground">
              Des questions concernant nos conditions générales de vente ?
            </p>
            <Button 
              variant="outline" 
              className="mt-4"
