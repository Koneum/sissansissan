    ...
    <section className="container mx-auto px-4 py-12">
      <div className="bg-gradient-to-r from-blue-600 to-blue-400 rounded-2xl p-8 md:p-12 text-white">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Don't Miss Out Latest Trends & Offers</h2>
          <p className="mb-8 text-blue-50">Register to receive news about the latest offers & discount codes</p>
