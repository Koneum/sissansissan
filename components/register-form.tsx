...
export default function RegisterForm() {
  ...
  // Détecter si c'est un appareil Apple au montage du composant
  useEffect(() => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
      ...
      {/* Social Login */}
      <div className={`grid ${isAppleDevice ? 'grid-cols-1 sm:grid-cols-3' : 'grid-cols-1 sm:grid-cols-2'} gap-2 sm:gap-3`}>
        <Button
          type="button"
          variant="outline"
        ...
        >
          ...
          <span className="text-responsive-sm">Google</span>
        </Button>
        <Button
          type="button"
          variant="outline"
        ...
        >
          ...
          <span className="text-responsive-sm">Facebook</span>
        </Button>
        {isAppleDevice && (
          <Button
            type="button"
